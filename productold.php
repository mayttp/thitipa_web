        ...
        <div class="container-menu-header">
            ...
            <div class="wrap_header">
                ...
                <a href="index.html" class="logo">
                    <img src="logo.png" width="120px" height="170px" alt="IMG-LOGO">
                </a>
                                            ...
                                            <div class="panel panel-login">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <form id="login-form"
                                                                action="https://phpoll.com/login/process" method="post"
                ...
                <div class="header-icons">
                    ...
                    <a href="#" class="header-wrapicon1 dis-block" data-toggle="modal" data-target="#exampleModal">
                                ...
                                while($row = mysqli_fetch_assoc($result)){
									...
									<div class="block2">
										<div class="block2-img wrap-pic-w of-hidden pos-relative">
											<img src="squishy/'.$pic.'" alt="IMG-PRODUCT">
