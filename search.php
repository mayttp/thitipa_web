            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="container">
                    <div class="row justify-content-around">
                        ...
                        <?php
                        $sql = "SELECT * FROM squishy.product WHERE pro_name LIKE '%$keyword%' OR pro_detail LIKE '%$keyword%' OR pro_price LIKE '%$keyword%' OR pro_type LIKE '%$keyword%'";
                        ...
                        if(mysqli_query($conn,$sql)){
                            if(mysqli_num_rows($result)>0){
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    <img src="squishy/'.$pic.'" class="card-img-top" height="200px" alt="">
                                    <div class="card-body">
