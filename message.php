            ...
            <div style="background: white">
                <div class="container" style="font-size:20px;">
                    ...
                    <form action="message_submit.php" method="POST">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                            <h4 for="validationCustomUsername">Email</h4>
                                <div class="input-group">
                                    <div class="input-group-prepend">

                                    </div>
                                    <input type="text" class="form-control" name="Email" placeholder="@simple.com"
                            ...
                            <div class="col-md-6">
                            <h4 for="validationCustom02">เบอร์โทรศัพท์</h4>
                                <input type="int" class="form-control" name="Tel" placeholder="" value="" required>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                            <br><h4>เลือกประเภทสินค้า</h4>
                                <input type="radio" name="pass3" value="Squishy" checked> Squishy<br>
                                <input type="radio" name="pass3" value="Doll"> Doll<br>
                                <input type="radio" name="pass3" value="Board Game"> Board Game<br>
                                <input type="radio" name="pass3" value="Toy"> Toy<br><br>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" name="Text" rows="4" style="width: 70%"></textarea>
                            </div>
                        </div>
